            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-5">
                        <img src={faqImage} alt="FAQs" /> {/* added alt text */}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div className="steps">
                            <div className="row">
                                <div className="col-lg-3">
                                    <div className="item">
                                        <img src="assets/images/services-01.jpg" alt="Project Introduction" style={{ maxWidth: '66px', borderRadius: '50%', margin: '0 auto' }} />
                                        <h4>Project Introduction</h4>
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="item">
                                        <img src="assets/images/services-02.jpg" alt="Work Development" style={{ maxWidth: '66px', borderRadius: '50%', margin: '0 auto' }} />
                                        <h4>Work Development</h4>
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="item">
                                        <img src="assets/images/services-03.jpg" alt="Data Analysis" style={{ maxWidth: '66px', borderRadius: '50%', margin: '0 auto' }} />
                                        <h4>Data Analysis</h4>
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="item last-item">
                                        <img src="assets/images/services-04.jpg" alt="Project Finishing" style={{ maxWidth: '66px', borderRadius: '50%', margin: '0 auto' }} />
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="get-free-quote">
                            <form id="free-quote" method="post" role="search" action="#"> {/* changed method from submit to post */}
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="section-heading">
